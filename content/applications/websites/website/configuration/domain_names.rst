...
It is required to create a CNAME record to forward your domain name to the address of your Odoo
database.
...
.. important::
   ...
   subdomains or prefixes)` (`yourdomain.com`), create a redirection 301 to are redirect visitors to
   `wwww.yourdomain.com`.
...
.. example::
   ...
   `www.yourdomain.com` but also with the naked domain `yourdomain.com`.
